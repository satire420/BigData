...
public class TextPreProcessor {
	...
	public static void main(String[] args) {
        ...
        // First create an instance of the TextPreProcessor class
        TextPreProcessor preprocessor = new TextPreProcessor();
        
        // Secondly, define some sample text to pr-eprocess
        String sampleText = "The quick brown fox jumps over the lazy dog";
        
        // Third. pre-process the sample text using the TextPreProcessor class
        List<String> processedTokens = preprocessor.process(sampleText);
        
        // Lastly, print the processed tokens
